...
const selectBoxbp = document.querySelector(".select-box-player"),
selectBtnBot = selectBoxbp.querySelector(".optionsb .bot"),
selectBtnPlayer = selectBoxbp.querySelector(".optionsb .player"),
...
selectBtnBot.onclick = ()=>{
    selectBoxbp.classList.add("hide");
